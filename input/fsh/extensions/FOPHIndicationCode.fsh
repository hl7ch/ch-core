...
Description: "Indication Code, as defined by the [FOPH list of healthcare benefits](https://fhir.ch/ig/ch-epl/index.html)</a> to be conveyed when referring to prescription/dispense/billing of medicinal products subject to a price model as defined by the FOPH."
