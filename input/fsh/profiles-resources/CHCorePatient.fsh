...
Description: "Base definition of the Patient resource for use in CH Core resources. Relevant are definitions by the eCH-0010 V7.0 data standard mailing address and eCH-0011 V8.1 data standard pesond data.
