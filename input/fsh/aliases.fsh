...
Alias: $DocumentEntry.classCode =                   http://fhir.ch/ig/ch-epr-term/ValueSet/DocumentEntry.classCode
Alias: $DocumentEntry.confidentialityCode =         http://fhir.ch/ig/ch-epr-term/ValueSet/DocumentEntry.confidentialityCode
Alias: $DocumentEntry.mimeType =                    http://fhir.ch/ig/ch-epr-term/ValueSet/DocumentEntry.mimeType
Alias: $DocumentEntry.languageCode =                http://fhir.ch/ig/ch-epr-term/ValueSet/DocumentEntry.languageCode
Alias: $DocumentEntry.formatCode =                  http://fhir.ch/ig/ch-epr-term/ValueSet/DocumentEntry.formatCode
Alias: $DocumentEntry.healthcareFacilityTypeCode =  http://fhir.ch/ig/ch-epr-term/ValueSet/DocumentEntry.healthcareFacilityTypeCode
...
Alias: $HCProfessional.hcProfession =               http://fhir.ch/ig/ch-epr-term/ValueSet/HCProfessional.hcProfession
