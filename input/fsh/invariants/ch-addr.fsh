...
Severity: #warning
// Expression: "value.code.memberOf('http://fhir.ch/ig/ch-term/ValueSet/bfs-country-codes')"
Expression: "value.code.memberOf('http://hl7.org/fhir/ValueSet/iso3166-1-2')"
