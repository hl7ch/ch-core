...
* -> "eCH-0046: 4.3 email"
* system -> "eCH-0046: 4.3 emailType"
* value -> "eCH-0046: 4.3 emailAddress"
* use -> "eCH-0046: 4.3 emailCategory/otherEmailCategory"
* use.extension[emailCategory] -> "eCH-0046: 4.3.1 emailCategory"
* period -> "eCH-0046: 4.3 validity"
