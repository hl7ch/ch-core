...
* -> "eCH-0046: 4.4 phone"
* system -> "eCH-0046: 4.4 phoneType"
* value -> "eCH-0046: 4.4 phoneNumber"
* use -> "eCH-0046: 4.4 phoneCategory/otherPhoneCategory"
* use.extension[phoneCategory] -> "eCH-0046: 4.4.1 phoneNumberCategory"
* period -> "eCH-0046: 4.4 validity"
