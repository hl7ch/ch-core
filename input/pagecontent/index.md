...
This implementation guide is under ballot for STU 2 by [HL7 Switzerland](https://www.hl7.ch/) until March 15th, 2021 midnight. Please add your feedback via the 'Propose a change'-link in the footer on the page where you have comments. [Changelog to STU 1](http://fhir.ch/ig/ch-core/comparison-v1.0.0/index.html))
</div>
